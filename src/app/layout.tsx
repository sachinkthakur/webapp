...
// import 'core-js/stable'; // Temporarily removed for debugging hydration issues
// import 'regenerator-runtime/runtime'; // Temporarily removed for debugging hydration issues
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <head>
        {/* PWA Meta Tags - Ensure no whitespace between meta tags */}
        ...
        <meta name="msapplication-TileColor" content="#007bff" /> {/* Updated color */}
        <meta name="msapplication-tap-highlight" content="no" />
        <meta name="theme-color" content="#ffffff" /> {/* Updated theme color */}
        {/* Icons */}
        ...
        <link rel="mask-icon" href="/icons/safari-pinned-tab.svg" color="#007bff" /> {/* Updated color */}
