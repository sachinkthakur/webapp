...
function HistoryPage() {
    ...
    const [currentUser, setCurrentUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null); // Store the full user object
        ...
        if (user.type === 'employee') {
            ...
            if (storedHistory) {
                try {
                    ...
                    const userHistory = allHistory.filter((record)=>record.userId === user.userId) // Filter for the current user's ID (phone number)
                    .map((record)=>({
                            ...record,
...
//# sourceMappingURL=src_b4dd51c5._.js.map